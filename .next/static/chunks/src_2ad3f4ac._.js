...
function FilesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "FilesPage.useEffect": ()=>{
            const fetchFiles = {
                "FilesPage.useEffect.fetchFiles": async ()=>{
                    try {
                        // For demo purposes, we'll just use the sample file
                        // In a real app, you'd fetch this from an API endpoint
                        setFiles([
                            {
                                name: "07-03-2025.csv",
                                path: "/files/07-03-2025.csv"
                            }
                        ]);
                        setLoading(false);
                    } catch (err) {
            ...
            }["FilesPage.useEffect.fetchFiles"];
            fetchFiles();
        }
    }["FilesPage.useEffect"], []);
    const handleTrigger = async (fileName)=>{
        try {
...
_s(FilesPage, "WpjDJQ6atgMYfH1iOEpTxvk5Ois=", false, function() {
    return [
...
//# sourceMappingURL=src_2ad3f4ac._.js.map